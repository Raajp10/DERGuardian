...
This script runs or rebuilds run phase3 lora extension artifacts for audits, figures,
...
extension experiment contexts. LoRA outputs are experimental explanation evidence, not detector benchmark evidence.
"""

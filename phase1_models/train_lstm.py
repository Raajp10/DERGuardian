...
This module implements train lstm logic for residual-window model training,
...
from phase1_models.neural_models import LSTMClassifier
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Train the repaired LSTM sequence classifier.")
    ...
    if args.run_mode == "legacy-smoke":
        ...
        result = {"model_name": "lstm", "metrics": full_result["summary"], "info": full_result["summary"]}
    print(f"Saved LSTM artifacts for {result['model_name']}")
